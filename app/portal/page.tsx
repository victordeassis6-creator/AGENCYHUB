    ...
    <div className="animate-fade-in-up">
      ...
      <div className="group relative overflow-hidden rounded-[2.5rem] bg-[#111113] border border-[#1e1e20] p-12 lg:p-16 flex flex-col md:flex-row md:items-center justify-between gap-8">
        ...
        <div className="relative z-10 max-w-xl">
          <p className="text-[10px] font-black uppercase text-indigo-400 tracking-[0.4em] mb-4 italic">Portal de Experiência</p>
      ...
      <div className="grid lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="flex items-center justify-between">
             <h3 className="text-base font-bold text-white flex items-center gap-2">
                <CheckSquare className="w-4 h-4 text-indigo-400" /> Aprovação de Conteúdo
             </h3>
          ...
          <div className="space-y-4">
             {contentToApprove.map((item) => (
                <div key={item.id} className="p-8 rounded-3xl bg-[#111113] border border-[#1e1e20] hover:border-slate-800 transition-all flex flex-col md:flex-row md:items-center justify-between gap-8 group">
                   <div className="flex items-center gap-8">
                      <div className="h-24 w-16 bg-white/5 rounded-2xl flex items-center justify-center text-[10px] font-black italic text-slate-600 border border-white/5 group-hover:border-indigo-500/20 overflow-hidden relative shadow-inner">
                         PREVIEW
                      </div>
                      <div>
                         <p className="text-xs font-black text-slate-600 uppercase tracking-widest mb-1 italic">{item.type} • {item.date}</p>
                         <p className="text-xl font-bold text-white group-hover:text-indigo-400 transition-colors">{item.title}</p>
                      </div>
                   </div>
        ...
        <div className="lg:col-span-4 space-y-8">
           <Card className="bg-[#111113] border-[#1e1e20] rounded-[2rem] p-8 space-y-8 relative overflow-hidden">
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="p-8 rounded-3xl bg-[#111113] border border-[#1e1e20] flex flex-col items-center justify-center text-center group cursor-pointer hover:bg-white/[0.02] transition-colors">
                 <Upload className="w-5 h-5 text-indigo-400 mb-3" />
